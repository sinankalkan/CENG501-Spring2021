'''downstream classifier using L-BFGS.

Reference:
[2] Chen, T.; Kornblith, S.; Norouzi, M.; and Hinton, G. 2020a.
...
def train_clf(X, y, representation_dim, num_classes, device, init_weights, reg_weight=1e-3):
