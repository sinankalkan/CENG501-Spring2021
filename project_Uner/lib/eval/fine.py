...
if __name__ == '__main__':
    ...
    fine_image_outputs = Path('/home/onur/Desktop/workspace/mos/saved/outputs/HRSOD/fine')
    fine_mask_outputs = Path('/home/onur/Desktop/workspace/mos/saved/outputs/HRSOD/fine_mask')
