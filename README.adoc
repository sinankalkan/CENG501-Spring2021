...
- Optimization method. Using Adams method.
- Learning rate. Set to initial rate of 0.015 and decrease by 20% when validation loss doesn't decrease for 2 epochs.
- Number of epochs for training set to 150.
