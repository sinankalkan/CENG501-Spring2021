...
class BaseTrainer(ABC):
    def __init__(self, config, resume, train_loader, save_dir, log_dir, val_loader=None):
        ...
        # OPTIMIZER
        self.optimizer = build_optimizer(self.model, optim=self.config.optimizer.type, **self.config.optimizer.args)
        self.lr_scheduler = build_lr_scheduler(self.optimizer, lr_scheduler=self.config.lr_scheduler.type,
